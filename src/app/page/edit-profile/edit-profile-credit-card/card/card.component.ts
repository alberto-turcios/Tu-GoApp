...
export class CardComponent implements OnInit, OnChanges {
  ...
  cardNumberViewChild!: ElementRef;
    @ViewChild('cardName', { static: false })
  cardNameViewChild!: ElementRef;
    @ViewChild('expireDate', { static: false })
  expireDateViewChild!: ElementRef;

    currentCardNumberPlaceholder!: string[];
    cardHolderNamePlaceholder!: string[];
    focusStyle!: { width: string; height: string; transition?: string; transform: string; } | null;
